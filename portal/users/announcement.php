...
<body>
    ...
    body {
        ...
        .weather-container {
            display: grid;
            grid-template-columns: repeat(1, 1fr); /*tiles per row */
            gap: 40px;
        ...
        .weather-info {
			background-color: rgba(159, 159, 159, 0.3); /* Translucent gray */
            padding: 20px;
            border-radius: 10px;
        ...
        .weather-info .more-info strong {
            color: #4CAF50;
        }

        @media (max-width: 1200px) {
            .weather-container {
                grid-template-columns: repeat(3, 1fr); /* 3 tiles per row on medium screens */
            }
        }

        @media (max-width: 900px) {
            .weather-container {
                grid-template-columns: repeat(2, 1fr); /* 2 tiles per row on smaller screens */
            }
        }

        @media (max-width: 600px) {
            .weather-container {
                grid-template-columns: 1fr; /* 1 tile per row on mobile screens */
            }
        }
