...
// Validate inputs
$missingFields = [];
foreach (['emergency_id' => $emergency_id, 'patient_name' => $patient_name, 'phone' => $phone, 'age' => $age, 'emergency_category' => $emergency_category, 'latitude' => $latitude, 'longitude' => $longitude, 'address' => $address, 'injury' => $injury, 'description' => $description, 'agency_id' => $agency_id, 'dates' => $dates] as $field => $value) {
