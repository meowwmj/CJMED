<div class="header">
			<div class="header-left">
				<a href="index.php#" class="logo">
					<img src="assets/img/pdr.png" width="35" height="35" alt=""> <span>PDRRMO</span>
				</a>
			</div>
                                    ...
                                    <a href="make_action.php?id=<?php echo $row['id'];?>"> 
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details">There is a <?php echo $row['case_severity'] ?> emergency at <span class="noti-title"><?php echo $row['address'] ?>, </span> the <span class="noti-time"><?php echo $row['agency_name'] ?></span> is needed</p>
