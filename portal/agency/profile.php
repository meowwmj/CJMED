                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        <h3 class="user-name m-t-0 mb-0"><?php echo $_SESSION['SESS_AGENCY_NAME'];?></h3>
                                ...
                                <div class="col-md-7">
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <span class="text"><?php echo $_SESSION['SESS_PHONE_NUMBER'];?></span>
                                        </li>
                                        <li>
...
<!-- Bootstrap Bundle (Modal support) -->
